...
export default function TimerModal({ navigation, route }) {
  ...
  const onEdit = useCallback(() => {
    ...
    requestAnimationFrame(() => {
      navigation.push('TrainingLog', { mode: 'edit', id: log.id, prefill: log });
    });
  }, [navigation, log?.id, log]);
  ...
  return (
    <View style={styles.wrap}>
      ...
      <Pressable onPress={() => setShowSheet(true)} style={styles.bottomBtnWrap}>
        <LinearGradient colors={[BR.gold1, BR.gold2]} start={{ x:0, y:0 }} end={{ x:1, y:1 }} style={styles.bottomBtn}>
      ...
      <View style={styles.overlay}>
        <View style={styles.sheet}>
          ...
          <Pressable onPress={primary.onPress} style={{ alignSelf: 'stretch' }}>
            <LinearGradient colors={[BR.gold1, BR.gold2]} start={{ x:0, y:0 }} end={{ x:1, y:1 }} style={styles.primary}>
...
const styles = StyleSheet.create({
  ...
  hTitle: { color: BR.gold1, fontSize: 28, fontWeight: '800' },
  hDate:  { color: BR.sub,   fontSize: 16, marginTop: 4 },
  hClose: {
    marginLeft: 10, width: 56, height: 56, borderRadius: 18,
    backgroundColor: '#3E2A24', alignItems: 'center', justifyContent: 'center',
  },
  ...
  bottomBtn: { height: 60, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
  ...
  closeBtn: { width: 38, height: 38, borderRadius: 12, backgroundColor: '#3E2A24', alignItems: 'center', justifyContent: 'center' },
  time: { color: BR.text, fontSize: 56, fontWeight: '800', letterSpacing: 1 },
  sub:  { color: BR.sub, fontSize: 16, marginTop: 4 },
  primary: { height: 56, borderRadius: 16, alignItems: 'center', justifyContent: 'center', marginTop: 8 },
