...
const DATE_INACTIVE = ['#4B2E2A', '#2A1A18'];
const DATE_ACTIVE   = ['#F3C34E', '#E06A1C'];
...
const styles = StyleSheet.create({
  ...
  emptyLogo: { width: 180, height: 180, marginBottom: 12 },
  ...
  cardDur: { color: BR.gold1, fontSize: 16, fontWeight: '800' },
  ...
  circleTxt: { color: '#fff', fontWeight: '700' },
