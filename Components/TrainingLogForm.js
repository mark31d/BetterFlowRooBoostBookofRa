...
function makeStyles(insets) {
  return StyleSheet.create({
    ...
    sliderTrack: { position: 'absolute', left: 6, right: 6, height: 4, borderRadius: 2, backgroundColor: BR.line },
    sliderTick: { position: 'absolute', top: 0, bottom: 0, alignItems: 'center', justifyContent: 'center', width: 0 },
    sliderDot:  { width: 10, height: 10, borderRadius: 5, backgroundColor: 'rgba(255,255,255,0.45)' },
    sliderDotActive: { width: 12, height: 12, borderRadius: 6, backgroundColor: '#fff' },
    ...
    squareBtn:  { width: 64, height: 64, borderRadius: 16, backgroundColor: '#3E2A24', alignItems: 'center', justifyContent: 'center' },
    ...
    cta: {
      ...
      shadowColor: '#000', shadowOpacity: 0.35, shadowRadius: 10, shadowOffset: { width: 0, height: 6 }, elevation: 6,
    },
    ctaTxt: { color: '#fff', fontSize: 18, fontWeight: '600' },
    prevBtn: { height: 48, borderRadius: 14, alignItems: 'center', justifyContent: 'center', backgroundColor: BR.panel, marginTop: 10, borderWidth: 1, borderColor: BR.line },
